...
public class MainActivity extends AppCompatActivity {
   ...
   String TAG="MainActivity";
    ...
    private void showVideo() {
        ...
        String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCtC3d_nTi9pViYUrH4U9gNA&maxResults=25&q="+searchName+"&key=AIzaSyCht2MumvCig7vkc_JD_K1eejw8XbXHcxQ";
